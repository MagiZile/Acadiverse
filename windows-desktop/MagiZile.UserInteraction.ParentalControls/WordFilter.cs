...
namespace MagiZile.UserInteractions.ParentalControls
{
    ...
    {
        readonly Dictionary<string, string> WordReplacements = new Dictionary<string, string>(); //This dictionary is for the clean replacements of bad words.
        readonly List<string> BadWords = new List<string>(); //This is the list of bad words.
        readonly List<string> LowExceptions = new List<string>();
        readonly List<string> ModerateExceptions = new List<string>();
        readonly List<string> slurs = new List<String>();
        ...
        public bool FilteredWordIsSlur()
        {
            return slurs.Contains(filteredWord);
        }
